...
class DoubleController(target: Supplier<out Double>, motionComponent: MotionComponents, toleranceEpsilon: Double, motors: SimpleMotor, calculators: List<Pair<IEnhancedNumberSupplier<Double>, CalculationComponent<Double>>>, indexedToUsrErr: Map<IEnhancedNumberSupplier<Double>, Boolean>) : ComplexController<Double>(target, motionComponent, toleranceEpsilon, motors, calculators, indexedToUsrErr) {
