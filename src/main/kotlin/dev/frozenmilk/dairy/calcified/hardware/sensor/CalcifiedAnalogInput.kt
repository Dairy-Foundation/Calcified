...
class CalcifiedAnalogInput(val module: CalcifiedModule, val port: Int) : EnhancedComparableNumericSupplier<Double, Conditional<Double>> by EnhancedDoubleSupplier({ module.bulkData.getAnalogInput(port).toDouble() })