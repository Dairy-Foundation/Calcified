...
class DoubleControllerCompiler private constructor(motors: SimpleMotor, calculators: List<Pair<IEnhancedNumberSupplier<Double>, CalculationComponent<Double>>>, indexedToUsrErr: Map<IEnhancedNumberSupplier<Double>, Boolean>, val currentSupplier: IEnhancedNumberSupplier<Double>?) : ControllerCompiler<Double>(motors, calculators, indexedToUsrErr) {
	...
	override fun withSupplier(enhancedSupplier: IEnhancedNumberSupplier<Double>, vararg motionComponents: MotionComponents) = DoubleControllerCompiler(motors, calculators, indexedToUsrErr, enhancedSupplier)
}