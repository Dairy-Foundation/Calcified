...
class EnhancedNumberSupplier<N: Number >(private val supplier: Supplier<out N>, private val modify: (N) -> N = { x -> x }, private val lowerDeadzone: Double = 0.0, private val upperDeadzone: Double = 0.0) : Supplier<Double> {
